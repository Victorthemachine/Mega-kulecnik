...
class Balls extends Component {
    ...
    adjustAngle() {
        document.getElementById("5").style.transform = "rotate(120deg)";
    }
    ...
    render() {
        ...
        return (
            ...
            <>  
                ...
                <BALL_3 id={3} x={this.state.points[3].x} y={this.state.points[3].y} width={ballRad} viewBox={viewBox} style={{rot}} key={4} />,
